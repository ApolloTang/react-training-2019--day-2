...
describe('[Selector, mapAppStateToProps]', ()=>{
  ...
  it('Should map store to todos property: ', () => {
    ...
    expect(mapAppStateToProps(fakeAppState, fakeOwnProps)).toEqual({todos:fakeAppState.todoApp.todos})
  })
})
...
describe('[Selector, mapDispatchToProps]', ()=>{
  ...
  it('dispatch_addTodo() and store receive correct action', () => {
    ...
    const fakeOwnProps = _set({}, 'location.search', '')
    const { dispatch_addTodo } = mapDispatchToProps(fakeDispatch, fakeOwnProps)
  ...
  it('dispatch_deleteTodo() and store receive correct action', () => {
    ...
    const fakeDispatch = fakeStore.dispatch
    const fakeOwnProps = _set({}, 'location.search', '')
    const { dispatch_deleteTodo } = mapDispatchToProps(fakeDispatch, fakeOwnProps)
  ...
  it('dispatch_toggleTodo() and store receive correct action', () => {
    ...
    const fakeDispatch = fakeStore.dispatch
    const fakeOwnProps = _set({}, 'location.search', '')
    const { dispatch_toggleTodo } = mapDispatchToProps(fakeDispatch, fakeOwnProps)
